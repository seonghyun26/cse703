...
def load_dataset(name, pattern, seed, instanceSize, trn_ratio=0.8, val_ratio=0.05, test_ratio=0.1):
    if name in [
        "arxiv",
        "Celegans",
        "Ecoli",
        ...
        "ogbl-ddi",
        "ogbl-collab",
    ] or name.startswith("jssp"):
        # NOTE: use different data on each training
        # name = name + "_" + str(i)
